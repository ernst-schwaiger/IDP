...
CPPCHECKOPTS="--cppcheck-build-dir=cppcheck-build --addon=misra --language=c++ --std=c++20 --enable=all --inconclusive --safety --platform=unix64 --checkers-report=report.txt --suppress=missingIncludeSystem"
